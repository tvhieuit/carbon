...
class QrScanBloc extends Bloc<QrScanEvent, QrScanState> {
  ...
  Future<void> _onQrCodeDetected(_QrCodeDetected event, Emitter<QrScanState> emit) async {
    ...
    final driverId = meResult.data!.id;
  ...
  void _onResetRequested(_ResetRequested event, Emitter<QrScanState> emit) {
